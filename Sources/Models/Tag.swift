...
final class Tag {
    ...
    var colorHex: String {
        get { colorHexRaw }
        set {
            if Tag.colorHexRegex.firstMatch(in: newValue, options: [], range: NSRange(location: 0, length: newValue.utf16.count)) != nil {
    ...
    init(id: UUID = UUID(), name: String, colorHex: String = "#808080") {
        self.id = id
        self.name = name
        self.colorHexRaw = colorHex // Initialize raw property first
